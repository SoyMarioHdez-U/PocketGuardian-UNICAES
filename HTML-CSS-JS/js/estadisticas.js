...
function dibujarCheques(cuentasGuardadas) {
    ...
    for (var i = 0; i < e; i++)
        ...
        var paginaRedireccion = "../html/prueba_insertar.php"
        str += '<button class="boton" onclick="window.location.href=\'' + paginaRedireccion + '\'">Añadir</button>';
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("ANTES DEL PUSH",nombresCuenta);
